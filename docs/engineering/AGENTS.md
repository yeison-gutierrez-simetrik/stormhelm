...
- §129 Migrations run through Drizzle's tracked migrator (forward-only, replay-safe) + a replay-safety CI gate; never a raw replay-all runner on a persistent DB
