...
- **126 numbered rules** (`§1 – §126`) that govern architecture, testing, security, supply chain, observability, and AFK operations. Skills load only the rules relevant to the task.
...
|---|---|---|
| `core` (stack-agnostic) | ✅ Shipped | every §N living in `docs/engineering/core/*.md` — 101 rules; remaining 25 are stack-specific |
