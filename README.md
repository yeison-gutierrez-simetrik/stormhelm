...
- **125 numbered rules** (`§1 – §125`) that govern architecture, testing, security, supply chain, observability, and AFK operations. Skills load only the rules relevant to the task.
...
|---|---|---|
| `core` (stack-agnostic) | ✅ Shipped | every §N living in `docs/engineering/core/*.md` — 100 rules; remaining 25 are stack-specific |
